...
#' Run pure R Bayesian approximation Bayesian Analysis
#'
#' @param data Study data
#' @param config CBAMM configuration
#' @return pure R Bayesian approximation results or NULL if failed
#' @keywords internal
...
#' Run pure R MCMC approximation Bayesian Analysis
#'
#' @param data Study data
#' @param config CBAMM configuration
#' @return pure R MCMC approximation results or NULL if failed
#' @keywords internal
...
#' @param method Either "brms" or "pure R MCMC approximation"
...
#' Get pure R MCMC approximation Model String
#'
#' @param prior_type Type of prior
#' @return pure R MCMC approximation model specification as string
#' @keywords internal
